...
<link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
			...
			<table>
					<tr>
						<td>Username: </td>
						<td><input type="text" value="<?php echo $_GET['username']; ?>" placeholder="Username" name="username" /></td>
					</tr>					<tr><td></td>
						<td colspan="2">
  ...
  if($_POST){
    ...
    //update user to table login
    $sql = "UPDATE login set username='".$_POST['username']."' WHERE id=".$_POST['id']."";
