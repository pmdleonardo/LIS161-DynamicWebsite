        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-preview">
            <a href="post.php">
              ...
              <h3 class="post-subtitle">
                The guy behind Abdul The Cool
              </h3>
            </a>
            <p class="post-meta">Posted by
              <a href="#">Abdul</a>
              on September 21, 2017</p>
          </div>
          <hr>
          <div class="post-preview">
            <a href="post.php">
          ...
          <div class="post-preview">
            <a href="post.php">
              ...
              <h3 class="post-subtitle">
                Learn the business principles of Abdul
              </h3>
            </a>
            <p class="post-meta">Posted by
              <a href="#">Abdul</a>
          ...
          <div class="post-preview">
            <a href="post.php">
              <h2 class="post-title">
                Integrating technology into your restaurant
              </h2>
              <h3 class="post-subtitle">
                Using your smartphone to manage your business
              </h3>
            </a>
            <p class="post-meta">Posted by
              <a href="#">Abdul</a>
